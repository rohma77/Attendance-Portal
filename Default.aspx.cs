...
public partial class Staff_Default : System.Web.UI.Page
{
    ...
    protected void btnupdate_Click(object sender, EventArgs e)
    {
             ...
             StaffAdapter.Update(Convert.ToInt32(ViewState["sid"].ToString()), txtemail.Text,
               txtmobile.Text, Imgprofile.ImageUrl.ToString(), txtadd.Text, txtcity.Text, txtpin.Text);
