...
<body>
    ...
    <div id="header">
        ...
        <asp:Image ID="Image3" runat="server" ImageUrl="~/img/Wallpaper.png" Width="100%" Height="220px" />
                 ...
                 <td colspan="2" 
                     ...
                     <table class="style3">
                         <tr>
                             ...
                             <td>
                                 Student login with username and password.</td>
                         </tr>
                     </table>
                 </td>
             </tr>
                 ...
                 <td colspan="2" 
                     ...
                     <table class="style3">
                         <tr>
                             ...
                             <td>
                                 <%--Staff can make attendance of student and generate reports afte login to system.--%>
	...
	<div class="ws_images">
<a href="#"><img src="img/Slide1.jpg" alt="" title="" id="wows0"/ width="100%"></a>
<a href="#"><img src="img/Slide2.jpg" alt="" title="" id="wows1"/ width="100%"></a>
<a href="#"><img src="img/Slide3.jpg" alt="" title="" id="wows2"/ width="100%"></a>
</div>
